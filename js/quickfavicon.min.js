// Uploading files
    ...
    jQuery(document).ready(function() {
      jQuery('.ios_icon_image_preview').css('background',jQuery('#quickfavicon_ios_icon_bg').val());
    });
    ...
    jQuery(document).ready(function() {
      jQuery('.android_icon_image_preview').css('background',jQuery('#quickfavicon_android_icon_bg').val());
    });

    // Detect Windows icon bg color radio button change
    jQuery('input[type=radio][name=quickfavicon_windows_tile_color_radio]').change(function() {
      if (this.value == 'white') {
        jQuery('input[type=hidden][name=quickfavicon_windows_tile_color]').val('#ffffff');
        jQuery('input[type=text][name=quickfavicon_windows_tile_color_visible]').prop('disabled', true);
        jQuery(this).closest('.options-section').find('.windows_icon_image_preview').css('background','#ffffff');
      }
      if (this.value == 'black') {
        jQuery('input[type=hidden][name=quickfavicon_windows_tile_color]').val('#000000');
        jQuery('input[type=text][name=quickfavicon_windows_tile_color_visible]').prop('disabled', true);
        jQuery(this).closest('.options-section').find('.windows_icon_image_preview').css('background','#000000');
      }
      if (this.value == 'transparent') {
        jQuery('input[type=hidden][name=quickfavicon_windows_tile_color]').val('');
        jQuery('input[type=text][name=quickfavicon_windows_tile_color_visible]').prop('disabled', true);
        jQuery(this).closest('.options-section').find('.windows_icon_image_preview').css('background','');
      }
      if (this.value == 'custom') {
        jQuery('input[type=text][name=quickfavicon_windows_tile_color_visible]').prop('disabled', false);
        jQuery(this).closest('.options-section').find('.windows_icon_image_preview').css('background',jQuery('#quickfavicon_windows_tile_color').val());
      }
    });
/*
